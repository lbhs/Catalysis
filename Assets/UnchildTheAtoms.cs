...
public class UnchildTheAtoms : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //INCORPORATE THE CODE BELOW INTO THIS SCRIPT SO THAT PE VALUES ARE SHOWN IN THE BLUE BADGES!!!!!
        //foreach (GameObject Atom in ChildAtoms)   //THIS APPLIES A POTENTIAL ENERGY TOKEN TO STARTING MOLECULES!!!   Need to populate MCToken List for Zero and One in the MoleculeListKeeper GameObject
        //{
        //    print(Atom);
        //    BadgeRecipient = Atom;
        //    j++;
